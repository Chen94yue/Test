...
class vgg_swap_2loss_add(nn.Module):
    def __init__(self, num_classes):
        super(vgg_swap_2loss_add,self).__init__()
        ...
        self.classifier_swap = nn.Linear(4096, num_classes*2)
        ...
        self.Convmask = nn.Conv2d(512, 1, 1, stride=1, padding=0, bias=False)
