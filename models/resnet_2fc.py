...
class resnet_2fc(nn.Module):
    def __init__(self, num_classes):
        ...
        self.att = nn.Conv3d(1,1,(1,14,14),(1,1,1), padding=0, bias=False)
        self.att.weight = torch.nn.Parameter(torch.ones(1,1,1,14,14)/(14*14))
    ...
    def forward(self, x):
        ...
        # x = self.maxpool(x5)
        # print(x.size())
        x = self.att(x5.view(-1,1,2048,14,14))
        x = x.view(x.size(0), -1)
        # print(x.size())
